...
### 4. Export
Click **CSV** to download annotations for the current image, or **All CSV** for every image in the session. 
- Exports include all annotation details plus `model_used`, `grid_rows`, `grid_cols`, and `is_custom_label`.
